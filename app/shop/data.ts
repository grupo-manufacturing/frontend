...
export const SHOP_PRODUCTS: ShopProduct[] = [
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 299 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 279 },
      { label: 'Silver', range: '100-499 units', unitPrice: 259 },
      { label: 'Gold', range: '500+ units', unitPrice: 239 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 429 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 409 },
      { label: 'Silver', range: '100-499 units', unitPrice: 389 },
      { label: 'Gold', range: '500+ units', unitPrice: 369 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 899 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 859 },
      { label: 'Silver', range: '100-499 units', unitPrice: 829 },
      { label: 'Gold', range: '500+ units', unitPrice: 789 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 699 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 669 },
      { label: 'Silver', range: '100-499 units', unitPrice: 639 },
      { label: 'Gold', range: '500+ units', unitPrice: 599 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 649 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 619 },
      { label: 'Silver', range: '100-499 units', unitPrice: 589 },
      { label: 'Gold', range: '500+ units', unitPrice: 559 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 1299 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 1249 },
      { label: 'Silver', range: '100-499 units', unitPrice: 1199 },
      { label: 'Gold', range: '500+ units', unitPrice: 1149 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 319 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 299 },
      { label: 'Silver', range: '100-499 units', unitPrice: 279 },
      { label: 'Gold', range: '500+ units', unitPrice: 259 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 949 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 909 },
      { label: 'Silver', range: '100-499 units', unitPrice: 879 },
      { label: 'Gold', range: '500+ units', unitPrice: 839 },
    ],
    inStock: false,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 399 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 379 },
      { label: 'Silver', range: '100-499 units', unitPrice: 359 },
      { label: 'Gold', range: '500+ units', unitPrice: 339 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 349 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 329 },
      { label: 'Silver', range: '100-499 units', unitPrice: 309 },
      { label: 'Gold', range: '500+ units', unitPrice: 289 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 1499 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 1449 },
      { label: 'Silver', range: '100-499 units', unitPrice: 1399 },
      { label: 'Gold', range: '500+ units', unitPrice: 1349 },
    ],
    inStock: true,
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    bulkPricing: [
      { label: 'Standard', range: '10-49 units', unitPrice: 479 },
      { label: 'Bronze', range: '50-99 units', unitPrice: 459 },
      { label: 'Silver', range: '100-499 units', unitPrice: 439 },
      { label: 'Gold', range: '500+ units', unitPrice: 419 },
    ],
    inStock: true,
  },
];
