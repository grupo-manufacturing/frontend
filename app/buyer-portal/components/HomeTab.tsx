        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {paginatedManufacturers.map((manufacturer) => (
              <div key={manufacturer.id} className="bg-white rounded-xl border border-[#1C8FD7]/30 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h3 className="text-lg font-semibold text-black">
                      {manufacturer.unit_name || 'Manufacturer'}
                    </h3>
                    <p className="text-xs text-[#1C8FD7] font-medium mt-1">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {manufacturer.product_types.slice(0, 3).map((productType) => (
                        <span
                          ...
                          className="px-2 py-0.5 rounded-full text-xs bg-[#1C8FD7]/10 text-[#1C8FD7] border border-[#1C8FD7]/20"
                        >
                          {productType}
                        </span>
                      ))}
