                    ...
                    {req.responses.map((response: any) => (
                      ...
                      >
                        ...
                        {response.status === 'accepted' && (
                          <div className="mt-4">
                            <a
                              href={`/invoice/requirement/${response.id}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
