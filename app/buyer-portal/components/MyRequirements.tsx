      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          {requirements.map((req: any) => (
            <div key={req.id} className="bg-white rounded-xl border border-[#1C8FD7]/30 p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
                ...
                {req.requirement_no && (
                  <span className="px-2 py-0.5 rounded-md text-xs font-semibold bg-[#1C8FD7]/10 text-[#1C8FD7] border border-[#1C8FD7]/20">
                    {req.requirement_no}
                  </span>
                )}
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-[#1C8FD7]">{req.manufacturer_count || 0} manufacturer{req.manufacturer_count !== 1 ? 's' : ''}</p>
                </div>
              </div>
              ...
              {req.product_link && (
                <div className="mb-4">
                  <a 
                    ...
                    className="text-sm text-[#1C8FD7] hover:underline flex items-center gap-1"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        ...
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                          ...
                          <div className="text-sm text-right">
                            <p className="font-semibold text-[#1C8FD7]">
          ...
          {!isLoadingRequirements && requirements.length === 0 && (
            <div className="bg-white rounded-xl border border-[#1C8FD7]/30 p-12">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                >
                  <div className="absolute inset-0 bg-[#1C8FD7] transition-transform group-hover:scale-105 rounded-xl"></div>
