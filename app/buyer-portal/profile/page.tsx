          ...
          {isLoadingProfile ? (
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-0 bg-[#1C8FD7]/15 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-300"></div>
                  <input
                    type="text"
                    value={formData.fullName}
                    onChange={(e) => handleInputChange('fullName', e.target.value)}
                    placeholder="Enter your full name"
                    className="relative w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#1C8FD7] focus:border-[#1C8FD7]/60 outline-none text-black placeholder:text-gray-500 transition-all"
                  />
                </div>
              </div>
