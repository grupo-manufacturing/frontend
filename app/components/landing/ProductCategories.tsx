...
const ProductCategories = () => {
  const features = [
    {
      title: 'OTP-based sign-in',
      description: 'OTP-based sign-in for buyer and manufacturer access.',
      icon: (
    ...
    },
    {
      ...
      description: 'Role-based portals for buyers, manufacturers, and admins.',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Requirements and responses',
      description: 'Requirement and response management workflows.',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Integrated messaging with conversation threads.',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'AI-assisted design generation and extraction.',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'Wholesale shop flow',
      description: 'Wholesale shop with checkout and order tracking.',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg sm:text-xl text-gray-600 text-center max-w-3xl mx-auto mb-16">
          The core capabilities that power collaboration across buyers, manufacturers, and wholesale operations.
        </p>
