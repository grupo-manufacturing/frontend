    ...
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#22a2f2] to-[#1c8fd7]">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
          Export Globally. Manage Locally.
        </h2>
        <p className="text-base sm:text-lg text-blue-50 max-w-3xl mx-auto mb-10 leading-relaxed">
          Whether you're a buyer sourcing from anywhere in the world or a manufacturer shipping internationally, Grupo handles payments, tracking, and operations for you.
        </p>
