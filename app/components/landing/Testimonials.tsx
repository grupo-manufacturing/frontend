  ...
  const placeholderQuotes = [
    {
      role: 'Buyer',
      quote:
        'Grupo helped us organize our requirements clearly and move from idea to manufacturer conversations much faster.',
    },
    {
      role: 'Manufacturer',
      quote:
        'The structured request flow and chat threads make it easier to evaluate opportunities and respond with confidence.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-2">
            ...
            <span className="text-sm text-blue-600 font-semibold">Social Proof</span>
          </div>
        </div>

        {/* Main Heading */}
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 text-center mb-4">
          Teams Building with Grupo
        </h2>

        {/* Subtitle */}
        <p className="text-lg sm:text-xl text-gray-600 text-center max-w-3xl mx-auto mb-16">
          See how brands and manufacturers use Grupo to move from requirement to execution faster.
        </p>

        {/* Placeholder Quotes */}
        <div className="grid md:grid-cols-2 gap-4 max-w-5xl mx-auto mb-12">
          {placeholderQuotes.map((item) => (
            <div key={item.role} className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
              <span className="inline-flex items-center text-xs font-semibold text-blue-700 bg-blue-50 border border-blue-200 rounded-full px-3 py-1 mb-4">
                {item.role}
              </span>
